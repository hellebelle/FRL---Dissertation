...
class Q_Learning_Model:
    ...
    def get_next_action(self, current_row_index, epsilon):
    ...
    def run(self):
        ...
        epsilon = 0.9 #the percentage of time when we should take the best action (instead of a random action/exploit instead of explore)
        ...
        for i in range(episodes):
             ...
             while traci.simulation.getMinExpectedNumber() > 0:
                ...
                if num_vehicles_at_det > 0:
                    ...
                    waiting_time_per_episode.append(cummulative_waiting_time)
                    occupancy = traci.inductionloop.getLastStepOccupancy(self.det_id)
                    #choose which action to take (i.e., where to move next)
                    action_index = self.get_next_action(row_index, epsilon)
        ...
        ax.plot(range(1,episodes+1), waiting_times) #Add a straight line to the axes of the first figure.
        ax.set_title('Cummulative Waiting Time of Vehicles per Episode')
...
if __name__ == "__main__":
    ...
    sumoBinary_gui = os.path.join(os.environ['SUMO_HOME'], 'bin', 'sumo.exe')
...
########### INCORRECT LOGIC BUT GIVES IDEAL Q-TABLE ###############
...
# [[446.83570321 591.39185689 582.49075259]
#  [518.40386347 416.71305832 690.27114661]
#  [732.97608372 546.02835463 507.69869849]]
